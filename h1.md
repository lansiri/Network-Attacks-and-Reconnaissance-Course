...
**Application Layer** data can be shown by pressing the hypertext transfer protocol, it sho
...
After fixing the http redirect and capturing the traffic from the command `curl http://app.sisuctf.com`

i can now see the normal packets from this conversation:
